# src/application/services/charging_station_service.py
from infrastructure.repositories.rated_charging_station_repository import RatedChargingStationRepository

class ChargingStationService:
    def __init__(self, repository: RatedChargingStationRepository):
    ...
    def add_rating_to_station(self, user_id: str, station_id: int, value: int, comment: str):
        ...
        Note: This is insecure as writing to database might fail (due to external errors like a loast internet
