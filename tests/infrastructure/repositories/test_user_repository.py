...
def mock_database(monkeypatch):
    ...
    monkeypatch.setattr("infrastructure.repositories.user_repository.db", mock_db)
    return mock_db
...
def test_load_from_empty_database(monkeypatch):
    ...
    monkeypatch.setattr("infrastructure.repositories.user_repository.db", EmptyFirebaseDB())
    repo = UserRepository("mocked_path")
    users = repo.load_from_database()
