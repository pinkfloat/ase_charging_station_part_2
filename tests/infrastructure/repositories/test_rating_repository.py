# tests/infrastructure/repositories/test_rating_repository.py
import pytest
...
def mock_database(monkeypatch):
    ...
    monkeypatch.setattr("infrastructure.repositories.rating_repository.db", mock_db)
    return mock_db
...
def test_load_station_ratings_from_empty_database(monkeypatch):
    ...
    monkeypatch.setattr("infrastructure.repositories.rating_repository.db", EmptyFirebaseDB())
    repo = RatingRepository("mocked_path")
    ratings = repo.load_station_ratings_from_database()
